...
//! Render an SVG into any impl of [`multirender::PaintScene`].
//!
...
/// Append an SVG to an [`multirender::PaintScene`].
///
...
/// Append an SVG to an [`multirender::PaintScene`] (with custom error handling).
///
...
/// Append a [`usvg::Tree`] to an [`multirender::PaintScene`].
///
/// This will draw a red box over (some) unsupported elements.
...
/// Append a [`usvg::Tree`] to an [`multirender::PaintScene`] (with custom error handling).
///
/// See the [module level documentation](crate#unsupported-features) for a list of some unsupported svg features
